...
- Create Angular project with ng: `ng new gestionappels.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`gestionappels.client.esproj`).
